...
def apply_discount(price:float, discount_tier:str) -> float:
    """ Apply a discount tier to a price and return the final price. 
        Available tier: silver,gold, bronze """
...
def run_agent(question:str):
    ...
    #now bind the llm with tools with bindtools()
            ...
            content=("You are a helpful shopping Assistant."
                      "You have access to product catalog tool"
                       "and a discount tool. \n\n"
                        ...
                        "1. Never guess or assume any product price or any random product. ALWAYS get the product from the  get_product_price()."
                        "You must call get_product_price first to get the real price. \n"
                         ...
                         "Always use the apply_discount tool to calculate discounts based on bronze,silver or gold value \n"
